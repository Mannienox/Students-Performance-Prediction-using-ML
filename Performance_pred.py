...
survey_form = {
    ...
    'How punctual will you be to the Real Analysis 1 class?': ['0: Will always arrive late', '1: Will frequently arrive late', '2: Will occasionally arrive late', '3: Will usually arrive on time', '4: Will always arrive on time'],
    ...
    'Do you like your course of study (Mathematics/Statistics)?' : ['0. No', '1. Yes'],
    'Do you like Real Analysis 1?': ['0. No', '1. Yes'],
    'How well are you understanding Real Analysis 1 so far?': ['2: Totally (I understood everything or almost everything)', '1. Partially (I understood some parts and crammed some)', '0. No Understanding (l crammed everything)'],
